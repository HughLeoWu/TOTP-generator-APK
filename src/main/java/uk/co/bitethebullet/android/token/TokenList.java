...
public class TokenList extends AppCompatActivity
	...
	private static final int NFC_ERROR = 0;
	private static final int TOTP_ERROR = 1;
	private static final int TOTP_COUNT = 2;

	private static String TAG = "NFCTOTP:";
	private String GOTP = null;
	...
	private NdefMessage createMessage() {
		...
		NdefMessage msg = new NdefMessage(
				new NdefRecord[] { NdefRecord.createMime(
						"application/com.jabil.chamberlain.demo", text.getBytes())
						/**
	...
	protected Dialog onCreateDialog(int id) {
		...
		switch(id){
			case TOTP_ERROR:
				d = createAlertDialog(R.string.tokenTOTPError);
				break;

			case NFC_ERROR:
				d = createAlertDialog(R.string.tokenNFCError);
				break;

			case TOTP_COUNT:
				d = createAlertDialog(R.string.tokenTOTPCount);
				break;
