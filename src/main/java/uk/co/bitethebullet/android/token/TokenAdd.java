...
public class TokenAdd extends AppCompatActivity {
	...
	private static final int DIALOG_STEP2_STRING_INVALID = 7;
	...
	protected Dialog onCreateDialog(int id) {
		...
		case DIALOG_STEP2_STRING_INVALID:
			d = createAlertDialog(R.string.tokenAddBase32Invalid);
			break;
	...
	private OnClickListener buttonComplete = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			char padding = '=';
			int length = 0;
			length = seed.length()%8;
			switch (length) {
				case 2: {
					seed = seed + padding + padding + padding + padding + padding + padding;
					break;
				}
				case 4: {
				...
				case 5: {
					seed = seed + padding + padding + padding;
					break;
				}
				case 7: {
					seed = seed + padding;
				...
				default:
					showDialog(DIALOG_STEP2_STRING_INVALID);
					return;
			}
			try {
